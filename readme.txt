=== Tabs ===
Contributors: ikhodal 
Tags: tabbed, tabs, responsive tabs, tabbed content, category, widget, woocommerce, wordpress tabs, category tabs, woocommerce tabs, tabs, tab, tabs shortcode
...
Wordpress tabs plugin creates the attractive tabbed content view by widget and shortcode with ajax paginations.
...
* <a rel="nofollow" href="http://www.ikhodal.com/category-and-post-tab/">Buy or view demo of tabs plugin</a> 
* <a rel="nofollow" href="http://www.ikhodal.com/documentation-category-and-post-tab/">Read Documentation</a> 
...
- [Create a support ticket for the multi languages or any other help](http://www.ikhodal.com/support)

== Installation ==

1. Upload and extract the zip file downloaded to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Navigate to 'CPT' page from dashboard and create new shortcode to add into any page content (Pro/Premium version only)
4. Configure widgets from Appearance > Widgets and assign to page sidebar.

== Frequently asked questions == 

= Can we override or change designing templates and style?  =

Yes, There is dynamic text and background color selection from admin panel.

= Can I use multiple widgets on the same page?  =

Yes, Supports multiple widgets to display category tab.

= Can I use multiple shortcode on the same or any page?  =

Yes, Only pro/premium version plugin supports multiple shortcodes (CPT) to display category tab.

= Is it fully responsive tabs plugin  =

Yes, this is fully responsive tabs for any kind of mobile devices.

= Is it fully responsive tabs plugin  =

Yes, this is fully responsive tabs for any kind of mobile devices.  

= Can we configured it with visual composer plugin.  =

Yes, this supports visual composer plugin.
...
= 1.0.0 =
* Plugin released.
* Tabs plugin testing with wordpress 1.9 version.
* Changed demo url.
